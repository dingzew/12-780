...
from drawingManageApp.views import loadDrawingRequest, addDrawingRecord, updateDrawingRecord
...
urlpatterns = [
    ...
    url(r'^loadDrawings/', loadDrawingRequest, name="loadDrawingsURL"),
    url(r'^addDrawing/', addDrawingRecord, name="addDrawingURL"),
    url(r'^updateDrawing/', updateDrawingRecord, name="updateDrawingURL"),
    url(r'^searchDrawing/', DrawingSearch, name="searchDrawingURL"),
]
